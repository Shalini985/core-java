package com.xwork.collectionDTOapp;
	...
	public class PlaceDTORunner {
		...
		public static void main(String[] args) {
			...
			Collection<PlaceDTO> palaceDTOs = new ArrayList<PlaceDTO>();
			palaceDTOs.add(new PlaceDTO("Banglore palace", "Banglore", "Dharshan", true, 10));
			palaceDTOs.add(new PlaceDTO("Mysore Palace", "Mysore", "Teja", false, 550));
			palaceDTOs.add(new PlaceDTO("Tippu Sulthan palace", "Sriranga pattana", "Omkar", true, 200));
			palaceDTOs.add(new PlaceDTO("Fort palace", "Chitadurga", "Vinoda", false, 101));
			palaceDTOs.add(new PlaceDTO("Lalitha Mahal", "Mysore", "Akshara", true, 5021));
