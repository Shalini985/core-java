...
import com.xwork.collectionDTOapp.Types;
...
public class WeaponDTO implements Comparable<WeaponDTO>  {
	...
	public WeaponDTO(String string, String string2, LocalDate localDate, double d, com.xwork.collectionDTOapp.Types firams) {
